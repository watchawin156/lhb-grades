...
var onRequest = /* @__PURE__ */ __name(async (context) => {
  ...
  if (request.method === "POST") {
    try {
      ...
      students.forEach((s) => {
        queries.push(db.prepare("INSERT INTO students (id, studentId, name, room, number) VALUES (?, ?, ?, ?, ?)").bind(s.id, s.code, s.name, s.room, s.number || null));
      });
...
// ../.wrangler/tmp/pages-DuFsK4/functionsRoutes-0.15186188486427765.mjs
var routes = [
  {
    routePath: "/api/data",
    mountPath: "/api",
