  ...
  if (request.method === "GET") {
    try {
      ...
      return Response.json({
        students,
        subjects: subRes.results.map((s) => ({
          ...s,
          year: s.year || Number(filterYear) || 2568
          // Fallback to selected year if it's a template
        })),
...
// ../.wrangler/tmp/pages-XyYhH8/functionsRoutes-0.9625809126587039.mjs
var routes = [
  {
    routePath: "/api/data",
    mountPath: "/api",
