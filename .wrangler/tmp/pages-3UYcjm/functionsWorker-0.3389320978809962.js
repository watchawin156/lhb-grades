...
var onRequest = /* @__PURE__ */ __name(async (context) => {
  ...
  if (request.method === "POST") {
    try {
      ...
      subjects.forEach((s) => {
        gradeQueries.push(db.prepare("INSERT OR REPLACE INTO subjects (id, code, name, maxScore, semester, type, credit, class_level, year) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)").bind(s.id, s.code, s.name, s.maxScore, s.semester, s.type || "\u0E1E\u0E37\u0E49\u0E19\u0E10\u0E32\u0E19", s.credit || 1, s.class_level, s.year));
      });
...
// ../.wrangler/tmp/pages-3UYcjm/functionsRoutes-0.6356646936876175.mjs
var routes = [
  {
    routePath: "/api/data",
    mountPath: "/api",
